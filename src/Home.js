        ...
        <div className="home">
            <div className="home_container">
                ...
                <div className="home_row">
                    <Product
                        id="0000001"
                        title='The Harry Potter Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj'
                        price={19.99}
                    ...
                    <Product
                        id="0000002"
                        title='iPhone X 64gb silver Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj'
                        price={600.00}
                ...
                <div className="home_row">
                    <Product
                        id="0000003"
                        title='The knife Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj'
                        price={5.78}
                    ...
                    <Product
                        id="0000004"
                        title='The Kenwoood Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj '
                        price={350.50}
                    ...
                    <Product
                        id="0000005"
                        title='T-Shirt S size Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj'
                        price={10.99}
                ...
                <div className="home_row">
                    <Product
                        id="0000006"
                        title='The TV Obohuma wgkberkjg ergb kjerg kerk gerk gker gkjberkj gker gkberqk gqer kgkqrgb kerq kgj'
                        price={800.00}
